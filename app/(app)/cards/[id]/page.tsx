            ...
            <div className="absolute top-4 right-16">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  <DropdownMenuItem onClick={handleChangePIN}>
                    Change PIN
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={handleBlockCard}>
                    Block Card
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={handleReportLost}>
                    Report Lost
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            ...
            <div className="space-y-3">
              {limits.map((limit, index) => (
                <DetailItem
                  key={index}
                  label={limit.type}
                  value={formatCurrency(limit.amount, limit.currency)}
                />
              ))}
            </div>
          </motion.div>
